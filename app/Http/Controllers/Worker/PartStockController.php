    ...
    public function index(Request $request)
{
    ...
    // If the user is a worker, restrict results to the active branch
    ...
    return view('worker.partstocks.index', compact('partStocks', 'date', 'search'));
}
    ...
    {
        $branches = Branch::all();
        return view('worker.partstocks.create', compact('branches'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('worker.partstocks.index')->with('success', 'Part stock added successfully.');
    }
    ...
    {
        $branches = Branch::all();
        return view('worker.partstocks.edit', compact('partStock', 'branches'));
    }
    ...
    public function update(Request $request, PartStock $partStock)
    {
        ...
        // Redirect to the index with a success message
        return redirect()->route('worker.partstocks.index')->with('success', 'Part stock updated successfully.');
    }
    ...
    public function updatePayment(Request $request, PartStock $partStock)
    {
        ...
        return redirect()->route('worker.partstocks.show', $partStock->id)->with('success', 'Payment updated successfully.');
