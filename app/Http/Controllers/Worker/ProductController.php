...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('worker.products.index', compact('products', 'date', 'search'));
    }
    

    public function create()
    {
        $branches = Branch::all(); // Get all branches (only for worker)
    ...
    {  
        return view('worker.products.show', compact('product'));
    }
        ...
        public function updatePayment(Request $request, Product $product)
    {
        ...
        return redirect()->route('worker.products.show', $product->id)->with('success', 'Payment updated successfully.');
    }
