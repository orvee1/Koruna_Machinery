...
class PartStockSaleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.partstock-sales.index', compact('salesGrouped'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($partStock->quantity < $validated['quantity']) {
            return redirect()->route('manager.partstock-sales.create')
        ...
        return redirect()->route('manager.partstock-sales.index')
    ...
    public function show($id)
    {
        ...
        return view('manager.partstock-sales.show', compact('partStockSale'));
    }
