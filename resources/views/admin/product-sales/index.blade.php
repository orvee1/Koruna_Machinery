...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2>Product Sales</h2>
        <a href="{{ route('admin.product-sales.create') }}" class="btn btn-primary">Add Sale</a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.product-sales.edit', $sale->id) }}" class="btn btn-sm btn-warning">Edit</a>
