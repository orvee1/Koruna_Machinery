...
<div class="container mt-4">
    ...
    <!-- Filter/Search -->
    <form method="GET" action="{{ route('worker.partstocks.index') }}" class="row g-2 mb-3">
        <div class="col-md-3">
        ...
        <div class="col-md-auto">
            <a href="{{ route('worker.partstocks.index') }}" class="btn btn-secondary"><i class="bi bi-x-circle"></i> Clear</a>
        </div>
        <div class="col-md-auto ms-auto">
            <a href="{{ route('worker.partstocks.create') }}" class="btn btn-success shadow-sm">
            ...
            <tbody>
                @forelse($partstocks as $key => $partstock)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('worker.partstocks.edit', $partstock->id) }}" class="btn btn-sm btn-warning">Edit</a>
                            <a href="{{ route('worker.partstocks.show', $partstock->id) }}" class="btn btn-sm btn-info">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
