...
<div class="container-fluid">
    ...
    <h1 class="mb-4 text-center">Worker Dashboard</h1>
   ...
   <form method="GET" class="card shadow-sm p-4 mb-4 border-0 bg-light">
    <div class="row g-3 align-items-end">
        ...
        <a href="{{ route('worker.dashboard') }}" class="btn btn-outline-secondary w-100">
            ...
            <div class="card shadow-sm rounded-lg p-4 text-center h-100">
                <div class="card-body">
                    ...
                    <div class="card-footer text-muted">
                        Showing profit for <strong>today</strong>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm rounded-lg p-4 text-center h-100">
                <div class="card-body">
                    ...
                    <p class="card-text fs-4 {{ $totalDueToHave > 0 ? 'text-danger' : 'text-success' }}">
                        {{ number_format($totalDueToHave, 2) }} ৳
                    </p>
                </div>
