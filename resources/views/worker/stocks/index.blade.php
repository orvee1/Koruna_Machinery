...
<div class="container mt-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        ...
        <a href="{{ route('worker.stocks.create') }}" class="btn btn-success shadow-sm">
            ➕ Add New Stock
        </a>
    </div>
    ...
    <form method="GET" class="row g-2 mb-4">
        ...
        <div class="col-md-2">
            <a href="{{ route('worker.stocks.index') }}" class="btn btn-outline-secondary w-100">
                ❌ Clear
            </a>
        </div>
    </form>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('worker.stocks.show', $stock) }}"
                                       class="btn btn-sm btn-outline-primary" title="View Details">
                                        🔍
                                    </a>
                                    <a href="{{ route('worker.stocks.edit', $stock) }}"
