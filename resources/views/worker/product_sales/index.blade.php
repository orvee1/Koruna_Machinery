...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2>Product Sales</h2>
        <a href="{{ route('worker.product-sales.create') }}" class="btn btn-primary">Add Sale</a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('worker.product-sales.edit', $sale->id) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('worker.product-sales.destroy', $sale->id) }}" method="POST" class="d-inline-block"
