...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('manager.product-sales.create') }}" class="btn btn-success">
            ➕ Add New Sale
        </a>
    </div>
    ...
    {{-- 🔎 Filter --}}
    <form method="GET" action="{{ route('manager.product-sales.index') }}" class="row gy-2 gx-3 align-items-end mb-4">
    {{-- Date --}}
    <div class="col-auto">
    ...
    @foreach($salesGrouped as $group)
        <tr>
            ...
            <td class="text-center">
                <a href="{{ route('manager.product-sales.show', $group['sales'][0]->id) }}" class="btn btn-sm btn-info">🔎 View</a>
                 <form action="{{ route('manager.product-sales.destroy', $group['sales'][0]->id) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure you want to delete this group sale?');">
                @csrf
                 @method('DELETE')
