...
<div class="container">
    <h3 class="mb-3">🧾 Bill #{{ $bill->id }}</h3>
     <a href="{{ route('manager.sales.print', $bill->id) }}" target="_blank" class="btn btn-outline-primary mb-4">
    🖨️ Print Invoice
    </a>
    ...
    <div class="card shadow-lg p-4 mb-5">
        ...
        <form action="{{ route('manager.sales.updatePayment', $bill->id) }}" method="POST">
            @csrf
            <div class="row">
    ...
    <div class="card shadow-lg p-4 mb-5">
        ...
        <table class="table table-bordered table-striped">
         ...
         <a href="{{ route('manager.sales.index') }}" class="btn btn-secondary mt-3">
            ← Back to List
     </a>
    </div>
</div>
