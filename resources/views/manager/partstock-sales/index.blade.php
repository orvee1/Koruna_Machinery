            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('manager.partstock-sales.edit', $sale->id) }}" class="btn btn-sm btn-warning">Edit</a>
                        <a href="{{ route('manager.partstock-sales.show', $sale->id) }}" class="btn btn-sm btn-info">View</a>
                        <form action="{{ route('manager.partstock-sales.destroy', $sale->id) }}" method="POST" class="d-inline-block"
